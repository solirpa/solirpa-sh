...
import { toNotionImageUrl, toNotionRendererBlockMap } from "../core/notion/utils";
...
export const getStaticPaths: GetStaticPaths = async () => {
  const table = await getTableData<Project>(PROJECT_INDEX_ID, true);
  return {
  ...
  return (
    <>
      <NextSeo
        ...
        canonical={`https://april-zhh.cn/${post.slug}`}
        openGraph={{
          type: "article",
